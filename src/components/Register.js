            ...
            <div className='row'>
              ...
              <div className='col-lg-4 col-md-12 col-sm-12 border-class'>
                ...
                <form className='register-form' onSubmit={handleSubmit}>
                  <label className='mb-2 fullname my-label' htmlFor='username'>
                    Full Name
                  ...
                  <label className='mb-2 mt-3 email my-label' htmlFor='email'>
                    Email Id
                  ...
                  <label className='mb-2 mt-3 gender my-label' htmlFor='gender'>
                    Gender
                  ...
                  <label className=' mb-2 mt-3 dob my-label' htmlFor='dob'>
                    Date of birth
                  ...
                  <label
                    className=' mb-2 mt-3 password my-label'
                    htmlFor='password'>
                    Password
                  ...
                  <label
                    className='mb-2 mt-3 confirm my-label'
                    htmlFor='confirmpwd'>
                    Confirm Password
                    <span
                      className={
