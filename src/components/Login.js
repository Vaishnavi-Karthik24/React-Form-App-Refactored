...
const Login = () => {
  ...
  const validInput = async () => {
    ...
    // try {
    //   const loggedInUser = await Parse.User.logIn(user)
        ...
        <section
          ...
          <form
            ...
            <div className='input-fields'>
              <label
                className=' mb-2 fullname my-label w-auto'
                htmlFor='username'>
                Full Name
              </label>
              <input
            ...
            <div className='input-fields'>
              <label className='mb-2 fullname my-label w-auto' htmlFor='email'>
                Email
              </label>
              <input
                className='form-control form-control-lg'
            ...
            <div className='input-fields'>
              <label
                className='mb-2 fullname my-label w-auto mt-3'
                htmlFor='password'>
                Password
              </label>
              <input
